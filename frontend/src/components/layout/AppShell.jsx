...
function AppShell({ children }) {
  return (
    <div className="min-h-screen bg-white text-gray-900 dark:bg-gray-900 dark:text-white transition-colors duration-500 overflow-x-hidden">
      ...
      <Navbar />
      <main className="mx-auto min-h-[calc(100vh-12rem)] max-w-7xl px-4 pb-40 pt-24 sm:px-6 lg:px-8 lg:pb-16 lg:pt-32 bg-white dark:bg-gray-900 transition-colors duration-500">
        {children}
      </main>
      <Footer />
      <MobileBottomNav />
